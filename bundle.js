...
var _eskimoblood$elm_color_extra$Color_Convert$hexToColor = function (_p11) {
	return A2(
		_elm_lang$core$Result$andThen,
		function (rs) {
			var _p12 = A2(
				_elm_lang$core$List$map,
				_elm_lang$core$Maybe$map(_fredcy$elm_parseint$ParseInt$parseIntHex),
				rs);
			if ((((((((((_p12.ctor === '::') && (_p12._0.ctor === 'Just')) && (_p12._0._0.ctor === 'Ok')) && (_p12._1.ctor === '::')) && (_p12._1._0.ctor === 'Just')) && (_p12._1._0._0.ctor === 'Ok')) && (_p12._1._1.ctor === '::')) && (_p12._1._1._0.ctor === 'Just')) && (_p12._1._1._0._0.ctor === 'Ok')) && (_p12._1._1._1.ctor === '[]')) {
				return _elm_lang$core$Result$Ok(
					A3(_elm_lang$core$Color$rgb, _p12._0._0._0, _p12._1._0._0._0, _p12._1._1._0._0._0));
			} else {
...
var _eskimoblood$elm_color_extra$Color_Convert$toPercentString = function (_p13) {
	return A3(
...
var _eskimoblood$elm_color_extra$Color_Convert$hueToString = function (_p14) {
...
var _eskimoblood$elm_color_extra$Color_Convert$colorToCssHsla = function (cl) {
	var _p15 = _elm_lang$core$Color$toHsl(cl);
	var hue = _p15.hue;
	var saturation = _p15.saturation;
	var lightness = _p15.lightness;
...
var _eskimoblood$elm_color_extra$Color_Convert$colorToCssHsl = function (cl) {
	var _p16 = _elm_lang$core$Color$toHsl(cl);
	var hue = _p16.hue;
	var saturation = _p16.saturation;
	var lightness = _p16.lightness;
...
var _eskimoblood$elm_color_extra$Color_Convert$colorToCssRgba = function (cl) {
	var _p17 = _elm_lang$core$Color$toRgb(cl);
	var red = _p17.red;
	var green = _p17.green;
	var blue = _p17.blue;
	var alpha = _p17.alpha;
	return A2(
		_eskimoblood$elm_color_extra$Color_Convert$cssColorString,
		'rgba',
		{
...
var _eskimoblood$elm_color_extra$Color_Convert$colorToCssRgb = function (cl) {
	var _p18 = _elm_lang$core$Color$toRgb(cl);
	var red = _p18.red;
...
var _avh4$elm_beautiful_example$BeautifulExample$elmLogo = function (color) {
	return A2(
			...
			_1: {
				...
				_1: {
					...
					_0: _elm_lang$html$Html_Attributes$style(
						{
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'height', _1: '0.8em'},
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
			...
			_0: A2(
				_elm_lang$svg$Svg$polygon,
				{
					...
					_0: _elm_lang$svg$Svg_Attributes$fill(
						_eskimoblood$elm_color_extra$Color_Convert$colorToCssRgb(color)),
					_1: {
						ctor: '::',
...
var _avh4$elm_beautiful_example$BeautifulExample$githubIcon = function (color) {
	return A2(
		_elm_lang$svg$Svg$svg,
		{
			ctor: '::',
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$d('M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.013 8.013 0 0 0 16 8c0-4.42-3.58-8-8-8z'),
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$fill(
							_eskimoblood$elm_color_extra$Color_Convert$colorToCssRgb(color)),
						_1: {
							ctor: '::',
							_0: A2(_elm_lang$html$Html_Attributes$attribute, 'fill-rule', 'evenodd'),
							_1: {ctor: '[]'}
						}
					}
				},
...
var _avh4$elm_beautiful_example$BeautifulExample$view = F2(
	function (config, content) {
		var _p0 = _elm_lang$core$Color$toHsl(
			A2(_elm_lang$core$Maybe$withDefault, _elm_lang$core$Color$gray, config.color));
		var hue = _p0.hue;
		var saturation = _p0.saturation;
		var lightness = _p0.lightness;
		var headingColor = A3(_elm_lang$core$Color$hsl, hue, saturation, lightness * 0.7);
		var detailsColor = A3(_elm_lang$core$Color$hsl, hue, saturation * 0.8, (lightness * 0.5) + 0.3);
		var backgroundColor = A3(_elm_lang$core$Color$hsl, hue, saturation * 1.2, (lightness * 5.0e-2) + 0.93);
		return A2(
								...
								_1: {
									...
									_1: {
										...
										_0: {
											ctor: '_Tuple2',
											_0: 'color',
											_1: _eskimoblood$elm_color_extra$Color_Convert$colorToCssRgb(headingColor)
										},
										_1: {ctor: '[]'}
									}
								}
					...
					_elm_lang$core$List$concat(
						{
							...
							_1: {
								ctor: '::',
								_0: function () {
									var _p2 = config.documentationUrl;
									if (_p2.ctor === 'Nothing') {
										return {ctor: '[]'};
									} else {
										return {
											...
											_1: {
												...
												_0: A2(
													_elm_lang$html$Html$a,
													{
														...
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$title('view documentation'),
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$style(
																	{
													...
													{
														ctor: '::',
														_0: _avh4$elm_beautiful_example$BeautifulExample$elmLogo(detailsColor),
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											}
												...
												_1: {
													...
													_0: A2(
														_elm_lang$html$Html$a,
														{
															...
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$title('view on github'),
																_1: {
																	ctor: '::',
																	_0: _elm_lang$html$Html_Attributes$style(
																		{
														...
														{
															ctor: '::',
															_0: _avh4$elm_beautiful_example$BeautifulExample$githubIcon(detailsColor),
															_1: {ctor: '[]'}
														}),
													_1: {ctor: '[]'}
												}
				...
				_1: {
					...
					_0: A2(
											...
											_1: {
												...
												_1: {
													...
													_0: {
														ctor: '_Tuple2',
														_0: 'color',
														_1: _eskimoblood$elm_color_extra$Color_Convert$colorToCssRgb(detailsColor)
													},
													_1: {ctor: '[]'}
												}
											}
						...
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(
								A2(_elm_lang$core$Maybe$withDefault, '', config.details)),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
								...
								_0: _elm_lang$html$Html_Attributes$style(
									{
										...
										_1: {
											...
											_0: {
												ctor: '_Tuple2',
												_0: 'background-color',
												_1: _eskimoblood$elm_color_extra$Color_Convert$colorToCssRgb(backgroundColor)
											},
											_1: {
												ctor: '::',
...
var _avh4$elm_beautiful_example$BeautifulExample$Config = F6(
	function (a, b, c, d, e, f) {
		return {title: a, details: b, color: c, maxWidth: d, githubUrl: e, documentationUrl: f};
	});
...
var _gabrielperales$game_of_life$GameOfLife$isAlive = F2(
	function (alive, neighbors) {
		return (alive && _elm_lang$core$Native_Utils.eq(neighbors, 2)) || _elm_lang$core$Native_Utils.eq(neighbors, 3);
	});
var _gabrielperales$game_of_life$GameOfLife$neighborsAlive = F2(
...
var _gabrielperales$game_of_life$GameOfLife$neighbors = function (cellCoords) {
	return A2(
		_elm_lang$core$List$map,
		function (t) {
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Tuple$first(t) + _elm_lang$core$Tuple$first(cellCoords),
				_1: _elm_lang$core$Tuple$second(t) + _elm_lang$core$Tuple$second(cellCoords)
			};
		},
		{
			ctor: '::',
...
var _gabrielperales$game_of_life$GameOfLife$coordsToIndex = F2(
	function (shape, coords) {
		var height = _elm_lang$core$Tuple$second(shape);
		var y = function (n) {
			return (_elm_lang$core$Native_Utils.cmp(height, 0) > 0) ? A2(_elm_lang$core$Basics_ops['%'], n, height) : n;
		}(
			_elm_lang$core$Tuple$first(coords));
		var width = _elm_lang$core$Tuple$first(shape);
		var x = function (n) {
			return (_elm_lang$core$Native_Utils.cmp(width, 0) > 0) ? A2(_elm_lang$core$Basics_ops['%'], n, width) : n;
		}(
			_elm_lang$core$Tuple$second(coords));
		return (y * width) + x;
	});
var _gabrielperales$game_of_life$GameOfLife$neighborsIndexes = F2(
	function (shape, coords) {
		return A2(
			_elm_lang$core$List$map,
			_gabrielperales$game_of_life$GameOfLife$coordsToIndex(shape),
			coords);
	});
var _gabrielperales$game_of_life$GameOfLife$indexToCoords = F2(
...
var _gabrielperales$game_of_life$GameOfLife$lifeCycle = function (board) {
	var boardCells = function (_) {
		return _.cells;
	}(board);
	var boardShape = function (_) {
		return _.shape;
	}(board);
	var nextCells = A2(
		...
		F2(
			function (index, cell) {
				return A2(
					_gabrielperales$game_of_life$GameOfLife$isAlive,
					cell,
					A2(
						_gabrielperales$game_of_life$GameOfLife$neighborsAlive,
						boardCells,
						A2(
							_gabrielperales$game_of_life$GameOfLife$neighborsIndexes,
							boardShape,
							_gabrielperales$game_of_life$GameOfLife$neighbors(
								A2(_gabrielperales$game_of_life$GameOfLife$indexToCoords, boardShape, index)))));
			}),
		boardCells);
...
var _gabrielperales$game_of_life$GameOfLife$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'Update':
				return (!function (_) {
					...
					ctor: '_Tuple2',
					_0: _gabrielperales$game_of_life$GameOfLife$lifeCycle(model),
			...
			case 'SwitchCell':
				var cells = A2(
					...
					F2(
						function (i, cell) {
							return (!_elm_lang$core$Native_Utils.eq(i, _p0._0)) ? cell : (!cell);
						}),
					function (_) {
						return _.cells;
					}(model));
...
var _gabrielperales$game_of_life$GameOfLife$empty = function (shape) {
	var boardLenght = _elm_lang$core$Tuple$first(shape) * _elm_lang$core$Tuple$second(shape);
	var cells = A2(_elm_lang$core$Array$repeat, boardLenght, false);
	return {cells: cells, shape: shape, paused: true};
};
var _gabrielperales$game_of_life$GameOfLife$Model = F3(
	function (a, b, c) {
		return {shape: a, cells: b, paused: c};
	});
var _gabrielperales$game_of_life$GameOfLife$SwitchPlay = {ctor: 'SwitchPlay'};
var _gabrielperales$game_of_life$GameOfLife$SwitchCell = function (a) {
	return {ctor: 'SwitchCell', _0: a};
};
var _gabrielperales$game_of_life$GameOfLife$view = function (model) {
	var split = F2(
		function (i, list) {
			var _p1 = A2(_elm_lang$core$List$take, i, list);
			if (_p1.ctor === '[]') {
				return {ctor: '[]'};
			} else {
				return {
	...
	var cells = function (_) {
		return _.cells;
	}(model);
	var width = _elm_lang$core$Tuple$second(
		function (_) {
			return _.shape;
		}(model));
	return A2(
		...
		{ctor: '[]'},
		{
														...
														_1: {
															...
															_1: {
																...
																_0: _elm_lang$html$Html_Events$onClick(
																	_gabrielperales$game_of_life$GameOfLife$SwitchCell(i)),
																_1: {ctor: '[]'}
															}
														}
													}
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(_gabrielperales$game_of_life$GameOfLife$SwitchPlay),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
...
var _gabrielperales$game_of_life$GameOfLife$Init = function (a) {
	return {ctor: 'Init', _0: a};
};
var _gabrielperales$game_of_life$GameOfLife$init = {
	ctor: '_Tuple2',
	_0: _gabrielperales$game_of_life$GameOfLife$empty(
		{ctor: '_Tuple2', _0: 20, _1: 20}),
	_1: A2(
		_elm_lang$core$Random$generate,
		_gabrielperales$game_of_life$GameOfLife$Init,
		A2(
			_elm_lang$core$Random$map,
			_elm_lang$core$Array$fromList,
			A2(_elm_lang$core$Random$list, 400, _elm_lang$core$Random$bool)))
};
var _gabrielperales$game_of_life$GameOfLife$Update = {ctor: 'Update'};
var _gabrielperales$game_of_life$GameOfLife$subscriptions = function (model) {
	return A2(
		_elm_lang$core$Time$every,
		_elm_lang$core$Time$second,
		function (_p2) {
			return _gabrielperales$game_of_life$GameOfLife$Update;
		});
};
var _gabrielperales$game_of_life$GameOfLife$main = _elm_lang$html$Html$program(
	{
		view: function (_p3) {
			return A2(
				_avh4$elm_beautiful_example$BeautifulExample$view,
				{
					title: 'Game of Life',
					...
					color: _elm_lang$core$Maybe$Just(_elm_lang$core$Color$blue),
					maxWidth: 478,
					githubUrl: _elm_lang$core$Maybe$Just('https://github.com/gabrielperales/game-of-life'),
					documentationUrl: _elm_lang$core$Maybe$Nothing
				},
				_gabrielperales$game_of_life$GameOfLife$view(_p3));
		},
		init: _gabrielperales$game_of_life$GameOfLife$init,
		update: _gabrielperales$game_of_life$GameOfLife$update,
		subscriptions: _gabrielperales$game_of_life$GameOfLife$subscriptions
	})();

var Elm = {};
Elm['GameOfLife'] = Elm['GameOfLife'] || {};
if (typeof _gabrielperales$game_of_life$GameOfLife$main !== 'undefined') {
    _gabrielperales$game_of_life$GameOfLife$main(Elm['GameOfLife'], 'GameOfLife', undefined);
}
